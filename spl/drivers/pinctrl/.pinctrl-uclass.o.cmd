cmd_spl/drivers/pinctrl/pinctrl-uclass.o := aarch64-linux-gnu-gcc -Wp,-MD,spl/drivers/pinctrl/.pinctrl-uclass.o.d  -nostdinc -isystem /usr/lib/gcc-cross/aarch64-linux-gnu/9/include -Ispl/include -Iinclude   -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -DCONFIG_SPL_BUILD -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -std=gnu11 -fshort-wchar -fno-strict-aliasing -fno-PIE -Os -fno-stack-protector -fno-delete-null-pointer-checks -Wno-stringop-truncation -Wno-maybe-uninitialized -fmacro-prefix-map=./= -g -fstack-usage -Wno-format-nonliteral -Wno-address-of-packed-member -Wno-unused-but-set-variable -Werror=date-time -ffunction-sections -fdata-sections -fno-stack-protector -D__ARM__ -mstrict-align -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -fno-common -ffixed-x18 -pipe -march=armv8-a -D__LINUX_ARM_ARCH__=8 -I./arch/arm/mach-rockchip/include    -DKBUILD_BASENAME='"pinctrl_uclass"'  -DKBUILD_MODNAME='"pinctrl_uclass"' -c -o spl/drivers/pinctrl/pinctrl-uclass.o drivers/pinctrl/pinctrl-uclass.c

source_spl/drivers/pinctrl/pinctrl-uclass.o := drivers/pinctrl/pinctrl-uclass.c

deps_spl/drivers/pinctrl/pinctrl-uclass.o := \
    $(wildcard include/config/spl/pinctrl/full.h) \
    $(wildcard include/config/spl/pinconf/recursive.h) \
  ...
  include/dm/util.h \
    $(wildcard include/config/spl/dm/warn.h) \
    $(wildcard include/config/debug/devres.h) \
    $(wildcard include/config/spl/of/platdata/inst.h) \
    $(wildcard include/config/spl/read/only.h) \

spl/drivers/pinctrl/pinctrl-uclass.o: $(deps_spl/drivers/pinctrl/pinctrl-uclass.o)
