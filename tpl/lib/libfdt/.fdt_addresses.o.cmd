cmd_tpl/lib/libfdt/fdt_addresses.o := aarch64-linux-gnu-gcc -Wp,-MD,tpl/lib/libfdt/.fdt_addresses.o.d  -nostdinc -isystem /usr/lib/gcc-cross/aarch64-linux-gnu/9/include -Itpl/include -Iinclude   -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -DCONFIG_SPL_BUILD -DCONFIG_TPL_BUILD -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -std=gnu11 -fshort-wchar -fno-strict-aliasing -fno-PIE -Os -fno-stack-protector -fno-delete-null-pointer-checks -Wno-stringop-truncation -Wno-maybe-uninitialized -fmacro-prefix-map=./= -g -fstack-usage -Wno-format-nonliteral -Wno-address-of-packed-member -Wno-unused-but-set-variable -Werror=date-time -ffunction-sections -fdata-sections -fno-stack-protector -I./scripts/dtc/libfdt -DFDT_ASSUME_MASK=0xff -D__ARM__ -mstrict-align -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -fno-common -ffixed-x18 -pipe -march=armv8-a -D__LINUX_ARM_ARCH__=8 -I./arch/arm/mach-rockchip/include    -DKBUILD_BASENAME='"fdt_addresses"'  -DKBUILD_MODNAME='"fdt_addresses"' -c -o tpl/lib/libfdt/fdt_addresses.o lib/libfdt/fdt_addresses.c

source_tpl/lib/libfdt/fdt_addresses.o := lib/libfdt/fdt_addresses.c

deps_tpl/lib/libfdt/fdt_addresses.o := \
...
tpl/lib/libfdt/fdt_addresses.o: $(deps_tpl/lib/libfdt/fdt_addresses.o)
