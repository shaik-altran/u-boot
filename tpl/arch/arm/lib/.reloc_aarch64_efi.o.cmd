cmd_tpl/arch/arm/lib/reloc_aarch64_efi.o := aarch64-linux-gnu-gcc -Wp,-MD,tpl/arch/arm/lib/.reloc_aarch64_efi.o.d  -nostdinc -isystem /usr/lib/gcc-cross/aarch64-linux-gnu/9/include -Itpl/include -Iinclude   -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -DCONFIG_SPL_BUILD -DCONFIG_TPL_BUILD -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -std=gnu11 -fshort-wchar -fno-strict-aliasing -fno-PIE -Os -fno-stack-protector -fno-delete-null-pointer-checks -Wno-stringop-truncation -Wno-maybe-uninitialized -fmacro-prefix-map=./= -g -fstack-usage -Wno-format-nonliteral -Wno-address-of-packed-member -Wno-unused-but-set-variable -Werror=date-time -fno-stack-protector -D__ARM__ -mstrict-align -fno-common -fno-common -ffixed-x18 -pipe -march=armv8-a -D__LINUX_ARM_ARCH__=8 -I./arch/arm/mach-rockchip/include -fpic -fshort-wchar    -DKBUILD_BASENAME='"reloc_aarch64_efi"'  -DKBUILD_MODNAME='"reloc_aarch64_efi"' -c -o tpl/arch/arm/lib/reloc_aarch64_efi.o arch/arm/lib/reloc_aarch64_efi.c

source_tpl/arch/arm/lib/reloc_aarch64_efi.o := arch/arm/lib/reloc_aarch64_efi.c

deps_tpl/arch/arm/lib/reloc_aarch64_efi.o := \
...
tpl/arch/arm/lib/reloc_aarch64_efi.o: $(deps_tpl/arch/arm/lib/reloc_aarch64_efi.o)
