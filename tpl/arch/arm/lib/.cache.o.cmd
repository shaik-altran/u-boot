cmd_tpl/arch/arm/lib/cache.o := aarch64-linux-gnu-gcc -Wp,-MD,tpl/arch/arm/lib/.cache.o.d  -nostdinc -isystem /usr/lib/gcc-cross/aarch64-linux-gnu/9/include -Itpl/include -Iinclude   -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -DCONFIG_SPL_BUILD -DCONFIG_TPL_BUILD -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -std=gnu11 -fshort-wchar -fno-strict-aliasing -fno-PIE -Os -fno-stack-protector -fno-delete-null-pointer-checks -Wno-stringop-truncation -Wno-maybe-uninitialized -fmacro-prefix-map=./= -g -fstack-usage -Wno-format-nonliteral -Wno-address-of-packed-member -Wno-unused-but-set-variable -Werror=date-time -ffunction-sections -fdata-sections -fno-stack-protector -D__ARM__ -mstrict-align -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -fno-common -ffixed-x18 -pipe -march=armv8-a -D__LINUX_ARM_ARCH__=8 -I./arch/arm/mach-rockchip/include    -DKBUILD_BASENAME='"cache"'  -DKBUILD_MODNAME='"cache"' -c -o tpl/arch/arm/lib/cache.o arch/arm/lib/cache.c

source_tpl/arch/arm/lib/cache.o := arch/arm/lib/cache.c

deps_tpl/arch/arm/lib/cache.o := \
...
tpl/arch/arm/lib/cache.o: $(deps_tpl/arch/arm/lib/cache.o)
