cmd_drivers/net/designware.o := aarch64-linux-gnu-gcc -Wp,-MD,drivers/net/.designware.o.d  -nostdinc -isystem /usr/lib/gcc-cross/aarch64-linux-gnu/9/include -Iinclude   -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -std=gnu11 -fshort-wchar -fno-strict-aliasing -fno-PIE -Os -fno-stack-protector -fno-delete-null-pointer-checks -Wno-stringop-truncation -Wno-maybe-uninitialized -fmacro-prefix-map=./= -g -fstack-usage -Wno-format-nonliteral -Wno-address-of-packed-member -Wno-unused-but-set-variable -Werror=date-time -D__ARM__ -fno-pic -mstrict-align -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -fno-common -ffixed-x18 -pipe -march=armv8-a -D__LINUX_ARM_ARCH__=8 -I./arch/arm/mach-rockchip/include    -DKBUILD_BASENAME='"designware"'  -DKBUILD_MODNAME='"designware"' -c -o drivers/net/designware.o drivers/net/designware.c

source_drivers/net/designware.o := drivers/net/designware.c

deps_drivers/net/designware.o := \
    $(wildcard include/config/dm/eth.h) \
    $(wildcard include/config/mdio/timeout.h) \
    $(wildcard include/config/dm/gpio.h) \
    $(wildcard include/config/dm/mdio.h) \
    $(wildcard include/config/tx/descr/num.h) \
    $(wildcard include/config/eth/bufsize.h) \
    $(wildcard include/config/dw/altdescriptor.h) \
    $(wildcard include/config/rx/descr/num.h) \
    $(wildcard include/config/macreset/timeout.h) \
    $(wildcard include/config/dw/mac/force/threshold/mode.h) \
    $(wildcard include/config/dw/axi/burst/len.h) \
  ...
  drivers/net/designware.h \
    ...
    $(wildcard include/config/dw/gmac/default/dma/pbl.h) \
  include/asm-generic/gpio.h \

drivers/net/designware.o: $(deps_drivers/net/designware.o)
