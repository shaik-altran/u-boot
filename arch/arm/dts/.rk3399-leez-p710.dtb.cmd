cmd_arch/arm/dts/rk3399-leez-p710.dtb := mkdir -p arch/arm/dts/ ; (cat arch/arm/dts/rk3399-leez-p710.dts; echo '$(pound)include "rk3399-leez-p710-u-boot.dtsi"') > arch/arm/dts/.rk3399-leez-p710.dtb.pre.tmp; aarch64-linux-gnu-gcc -E -Wp,-MD,arch/arm/dts/.rk3399-leez-p710.dtb.d.pre.tmp -nostdinc -I./arch/arm/dts -I./arch/arm/dts/include -Iinclude -I./include -I./arch/arm/include -include ./include/linux/kconfig.h -D__ASSEMBLY__ -undef -D__DTS__ -x assembler-with-cpp -o arch/arm/dts/.rk3399-leez-p710.dtb.dts.tmp arch/arm/dts/.rk3399-leez-p710.dtb.pre.tmp ; ./scripts/dtc/dtc -O dtb -o arch/arm/dts/rk3399-leez-p710.dtb -b 0 -i arch/arm/dts/  -Wno-unit_address_vs_reg -Wno-unit_address_format -Wno-avoid_unnecessary_addr_size -Wno-alias_paths -Wno-graph_child_address -Wno-graph_port -Wno-unique_unit_address -Wno-simple_bus_reg -Wno-pci_device_reg -Wno-pci_bridge -Wno-pci_device_bus_num   -Wno-unit_address_vs_reg -Wno-unit_address_format -Wno-avoid_unnecessary_addr_size -Wno-alias_paths -Wno-graph_child_address -Wno-graph_port -Wno-unique_unit_address -Wno-simple_bus_reg -Wno-pci_device_reg -Wno-pci_bridge -Wno-pci_device_bus_num  -d arch/arm/dts/.rk3399-leez-p710.dtb.d.dtc.tmp arch/arm/dts/.rk3399-leez-p710.dtb.dts.tmp || (echo "Check /home/shaik/u-boot/arch/arm/dts/.rk3399-leez-p710.dtb.pre.tmp for errors" && false) ; sed "s:arch/arm/dts/.rk3399-leez-p710.dtb.pre.tmp:arch/arm/dts/rk3399-leez-p710.dts:" arch/arm/dts/.rk3399-leez-p710.dtb.d.pre.tmp arch/arm/dts/.rk3399-leez-p710.dtb.d.dtc.tmp > arch/arm/dts/.rk3399-leez-p710.dtb.d

source_arch/arm/dts/rk3399-leez-p710.dtb := arch/arm/dts/rk3399-leez-p710.dts

deps_arch/arm/dts/rk3399-leez-p710.dtb := \
...
arch/arm/dts/rk3399-leez-p710.dtb: $(deps_arch/arm/dts/rk3399-leez-p710.dtb)
